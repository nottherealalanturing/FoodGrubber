    ...
    */
    ...
    'connections' => [
        ...
        'foody_admin' => [
            ...
            'database' => env(
                'DB_DATABASE_ADMIN',
                env('DB_CONNECTION_ADMIN', 'mysql') === 'sqlite'
                    ? database_path('foody_admin.sqlite')
                    : 'forge'
            ),
        ...
        'foody_customers' => [
            'driver' => env('DB_CONNECTION_CUSTOMERS', 'mysql'),
            'url' => env('DATABASE_URL_CUSTOMERS'),
            'host' => env('DB_HOST_CUSTOMERS', '127.0.0.1'),
            'port' => env('DB_PORT_CUSTOMERS', '3306'),
            'database' => env(
                'DB_DATABASE_CUSTOMERS',
                env('DB_CONNECTION_CUSTOMERS', 'mysql') === 'sqlite'
                    ? database_path('foody_customers.sqlite')
                    : 'forge'
            ),
